    ...
    return (
        <div id="about-me-page">
            ...
            <div id="about-me" className="text-center">
                ...
                In my free time, I enjoy playing the guitar, reading, and spending time with my wife and our two cats.
                <br />
                <br />
                ...
                My passion for programming was rekindled and I decided to pursue a Computer Science minor. I took courses in Data Structures and Algorithms, Foundations of Computation Theory, C++ Programming, and the Software Development Life Cycle.
                ...
                Please check out my projects <Link href="/projects">here</Link> and let me know what you think!
                </p>            
            </div>

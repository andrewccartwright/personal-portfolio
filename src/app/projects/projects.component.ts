...
export class ProjectsComponent {
  projects: Project[] = [
    {
      src: "/images/project-images/hj-cartwright.png",
    ...
    {
      src: "/images/project-images/tetris.png",
    ...
    {
      src: "/images/project-images/quasigroups.png",
    ...
    {
      src: "/images/project-images/proration.png",
    ...
    {
      src: "/images/project-images/snake.png",
